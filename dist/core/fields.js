...
export function parseApiFields(method, fields) {
...
export function parseAssignments(fields) {
...
export function parseAssignment(field) {
...
function parseJsonValue(rawValue, field) {
    try {
