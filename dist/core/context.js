...
import { createSecretStore, validateCredentials } from './secrets.js';
import { RestClient } from './api.js';
export async function createContext(options = {}, env = process.env) {
...
export async function resolveCredentials(profile, secretStore, env = process.env) {
